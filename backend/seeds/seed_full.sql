...
('Patna High Court Premises',  'GOVERNMENT',
 '{"type":"Polygon","coordinates":[[[85.1340,25.6000],[85.1380,25.6000],[85.1380,25.6040],[85.1340,25.6040],[85.1340,25.6000]]]}',
 '{"minLat":25.6000,"maxLat":25.6040,"minLon":85.1340,"maxLon":85.1380}',
 400, ARRAY['ADMIN','OFFICER'], 'Bihar High Court — alert on any crime within 400m', TRUE, 1),

('Patna Gandhi Maidan',        'GOVERNMENT',
 '{"type":"Polygon","coordinates":[[[85.1350,25.6095],[85.1400,25.6095],[85.1400,25.6135],[85.1350,25.6135],[85.1350,25.6095]]]}',
 '{"minLat":25.6095,"maxLat":25.6135,"minLon":85.1350,"maxLon":85.1400}',
 300, ARRAY['ADMIN','OFFICER'], 'Gandhi Maidan public assembly ground', TRUE, 1),

('Nalanda Mahavihara (UNESCO)', 'RELIGIOUS',
 '{"type":"Polygon","coordinates":[[[85.4450,25.1360],[85.4520,25.1360],[85.4520,25.1410],[85.4450,25.1410],[85.4450,25.1360]]]}',
 '{"minLat":25.1360,"maxLat":25.1410,"minLon":85.4450,"maxLon":85.4520}',
 500, ARRAY['ADMIN','OFFICER'], 'UNESCO World Heritage Site — tourist safety priority', TRUE, 1),

('Bodh Gaya Mahabodhi Temple',  'RELIGIOUS',
 '{"type":"Polygon","coordinates":[[[84.9900,24.6960],[84.9960,24.6960],[84.9960,24.7010],[84.9900,24.7010],[84.9900,24.6960]]]}',
 '{"minLat":24.6960,"maxLat":24.7010,"minLon":84.9900,"maxLon":84.9960}',
 600, ARRAY['ADMIN','OFFICER','ANALYST'], 'UNESCO Heritage — peak tourist season alert zone', TRUE, 2),

('PMCH Patna',                  'HOSPITAL',
 '{"type":"Polygon","coordinates":[[[85.1430,25.6120],[85.1490,25.6120],[85.1490,25.6160],[85.1430,25.6160],[85.1430,25.6120]]]}',
 '{"minLat":25.6120,"maxLat":25.6160,"minLon":85.1430,"maxLon":85.1490}',
 250, ARRAY['ADMIN','OFFICER'], 'Patna Medical College Hospital — no crime zone', TRUE, 1),

('IGIMS Patna',                 'HOSPITAL',
 '{"type":"Polygon","coordinates":[[[85.1630,25.6050],[85.1680,25.6050],[85.1680,25.6090],[85.1630,25.6090],[85.1630,25.6050]]]}',
 '{"minLat":25.6050,"maxLat":25.6090,"minLon":85.1630,"maxLon":85.1680}',
 250, ARRAY['ADMIN','OFFICER'], 'Indira Gandhi Institute of Medical Sciences', TRUE, 1),

('Patna University Campus',     'SCHOOL',
 '{"type":"Polygon","coordinates":[[[85.1210,25.6220],[85.1280,25.6220],[85.1280,25.6270],[85.1210,25.6270],[85.1210,25.6220]]]}',
 '{"minLat":25.6220,"maxLat":25.6270,"minLon":85.1210,"maxLon":85.1280}',
 300, ARRAY['ADMIN','OFFICER'], 'Women safety priority zone — university area', TRUE, 1),

('Bihar Raj Bhavan',            'GOVERNMENT',
 '{"type":"Polygon","coordinates":[[[85.1380,25.6000],[85.1430,25.6000],[85.1430,25.6040],[85.1380,25.6040],[85.1380,25.6000]]]}',
 '{"minLat":25.6000,"maxLat":25.6040,"minLon":85.1380,"maxLon":85.1430}',
 500, ARRAY['ADMIN'], 'Governor''s Residence — high security zone', TRUE, 1),

('India-Nepal Border Raxaul',   'BORDER',
 '{"type":"Polygon","coordinates":[[[84.8200,27.1800],[84.8400,27.1800],[84.8400,27.2000],[84.8200,27.2000],[84.8200,27.1800]]]}',
 '{"minLat":27.1800,"maxLat":27.2000,"minLon":84.8200,"maxLon":84.8400}',
 1000, ARRAY['ADMIN','OFFICER'], 'International border — smuggling alert zone', TRUE, 1),

('Gaya Airport',                'GOVERNMENT',
 '{"type":"Polygon","coordinates":[[[84.9500,24.7430],[84.9620,24.7430],[84.9620,24.7530],[84.9500,24.7530],[84.9500,24.7430]]]}',
 '{"minLat":24.7430,"maxLat":24.7530,"minLon":84.9500,"maxLon":84.9620}',
 500, ARRAY['ADMIN','OFFICER'], 'Airport security perimeter', TRUE, 2),

('BIT Patna',                   'SCHOOL',
 '{"type":"Polygon","coordinates":[[[85.1500,25.5980],[85.1560,25.5980],[85.1560,25.6020],[85.1500,25.6020],[85.1500,25.5980]]]}',
 '{"minLat":25.5980,"maxLat":25.6020,"minLon":85.1500,"maxLon":85.1560}',
 300, ARRAY['ADMIN','OFFICER'], 'Engineering college campus — women safety zone', TRUE, 1),

('Muzaffarpur Bus Stand',       'CUSTOM',
 '{"type":"Polygon","coordinates":[[[85.3880,26.1180],[85.3940,26.1180],[85.3940,26.1220],[85.3880,26.1220],[85.3880,26.1180]]]}',
 '{"minLat":26.1180,"maxLat":26.1220,"minLon":85.3880,"maxLon":85.3940}',
