...
import { addFIR, getFIR, listFIRs, bulkAddFIRs, addCctnsFIR, searchFIRs } from "../controllers/fir.controller.js";
import { protect, authorize } from "../middlewares/auth.middleware.js";
import { validate, validateParams, validateQuery } from "../middlewares/validate.middleware.js";
import { createFIRSchema, bulkFIRSchema, cctnsFIRSchema, firIdParamSchema, firQuerySchema, firSearchQuerySchema } from "../validators/fir.schema.js";
...
router.get("/search", protect, validateQuery(firSearchQuerySchema), searchFIRs);
